...
public class BatchConfiguration {
	...
	public Job importProductJob(JobRepository jobRepository, Step step1, JobCompletionNotificationListener listener,
								BatchMetricsListener batchMetricsListener, BatchLoggingListener batchLoggingListener) {
	...
	public Step step1(JobRepository jobRepository, DataSourceTransactionManager transactionManager,
					  ...
					  JdbcBatchItemWriter<Product> writer, BatchLoggingListener batchLoggingListener) {
